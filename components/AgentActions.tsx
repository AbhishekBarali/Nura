      ...
      >
        {safeActions.length === 0 && !isProcessing ? (
          <div className="flex flex-col items-center justify-center h-full text-center py-8">
            ...
            <p className="text-sm text-[var(--text-muted)]">Clinical findings appear here</p>
            <p className="text-xs text-[var(--text-muted)] mt-1">Medications, alerts, diagnoses, referrals</p>
          </div>
        ) : (
          <>
            {alerts.map((action) => (
