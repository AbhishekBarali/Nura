    ...
    <header className="border-b border-[var(--border-subtle)] bg-white sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 sm:gap-3 hover:opacity-80 transition-opacity">
          {/* Medical cross logo */}
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-blue-700 flex items-center justify-center">
          ...
          <div>
            <h1 className="text-lg sm:text-xl font-display font-bold text-[var(--text-primary)] tracking-tight">Nura</h1>
            <p className="text-[10px] sm:text-[11px] font-medium text-[var(--text-muted)] tracking-wide">
              <span className="hidden sm:inline">Clinical Documentation Agent</span>
              <span className="sm:hidden">Clinical AI Agent</span>
            </p>
          </div>
        </Link>
